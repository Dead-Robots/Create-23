...
def deliver_red_ring():
    ...
    straight_drive_distance(-50, 16, False)
    stop_motors(200)
    # turn towards the cube
    gyro_turn(-40, 40, 76, False)
    stop_motors(200)
...
def deliver_tall_rings(left_green):
    ...
    if left_green:
        ...
        # move forwards
        straight_drive_distance(40, 18.3, False)
        stop_motors(200)

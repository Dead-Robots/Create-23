...
def deliver_red_ring():
    ...
    ROBOT.run(straight_drive_distance, red=(-50, 17.5, False), green=(-50, 16.5, False))
    stop_motors(200)
...
def get_orange_ring():
    ...
    square_up_black(20, 20, 450)
    square_up_white(-10, -10, 450)
    square_up_black(5, 5, 450)
    stop_motors(100)
...
def deliver_orange_ring():
    ...
    stop_motors(200)
    square_up_white(-20, -20, 450)
    square_up_black(20, 20, 450)
    square_up_white(-10, -10, 450)
    square_up_black(10, 10, 450)
    square_up_white(-6, -6, 450)
    stop_motors(200)
...
def get_yellow_ring():
    ...
    ROBOT.run(gyro_turn, red=(-40, 40, 60, False), green=(-40, 40, 64.5, False))
    stop_motors(200)
...
def deliver_yellow_ring():
    ...
    stop_motors(200)
    square_up_black(30, 30, 450)
    square_up_white(-12, -12, 450)
    square_up_black(10, 10, 450)
    square_up_white(-8, -8, 450)
    square_up_black(6, 6, 450)
    ...
    msleep(100)
    # drive backwards
    straight_drive_distance(-20, 0.3, False)
    rake_manager.position = RakePositions.HIGH_KEY_PULL
    straight_drive_distance(-20, 4.3, False)
    rake_manager.position = RakePositions.REST
    servo.move(Claw.CLOSED, 0)
    stop_motors(200)
    straight_drive_distance(20, 5.2, False)
...
def deliver_tall_rings(left_green):
    ...
    if left_green:
        ...
        straight_drive_distance(70, 18.5, False)
        straight_drive_distance(35, 2, False)
        stop_motors(200)
